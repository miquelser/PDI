...
a persistence unit "PDIPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "PDI/pom.xml":
...
artifacts ("PDI-ejb.jar" and "PDI-web.war") are already built. You can build
